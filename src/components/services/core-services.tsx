      ...
      {/* <div className="relative h-[300vh]">
        <div className="sticky top-0 h-screen">
          {CORE_SERVICES_SCHEMA.map((r, i) => (
            <div
              key={i}
              className={`absolute inset-0 flex items-center justify-center transition-all duration-700 ${r.bgColor}`}
              style={{ zIndex: CORE_SERVICES_SCHEMA.length - i }}
            >
              <div className="md:p-2 p-4 rounded-3xl w-full max-w-6xl">
                <div className="grid md:grid-flow-col justify-between gap-10 p-9">
                  <div>
                    <img src={r.image} alt="product-design" />
                  </div>
