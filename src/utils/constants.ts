...
export const PRODUCT_SCHEMA: Product[]=[
    { id:1, slug: 'UIUX DESIGN', image:frame, href:"/digitalcase",   header:"HEALTH CARE", content:"Creating a telemedicine platform: Enhancing UI for virtual consultations"},
    { id:2, slug: 'UIUX DESIGN', image:frame,  href:"/digitalcase", header:"E-COMMERCE", content:"Revamping the shopping experience: Responsive design for mobile-first e-commerce"},
...
export const PROJECT_SCHEMA=[
    { id:1, slug: 'E-COMMERCE DESIGN', href:"/digitalcase", image:frame,  header:"HEALTH CARE", content:"Revolutionizing Healthcare Access: A UX/UI Case Study"},
