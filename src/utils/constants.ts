...
export const PRODUCT_SCHEMA: Product[]=[
    { id:1, slug: 'UIUX DESIGN', image:icon, href:"/digitalcase",   header:"HEALTH CARE", content:"Creating a telemedicine platform: Enhancing UI for virtual consultations"},
    ...
    { id:3, slug: 'UIUX DESIGN', image:icon, href:"/digitalcase", header:"EDUCATION",  content:"Developing an interactive learning platform: User experience for gamified education"},
    { id:4, slug: 'UIUX DESIGN', image:icon, href:"/digitalcase", header:"TRAVEL",     content:"Innovating itinerary planning: Seamless UX for travel booking applications"},
]
