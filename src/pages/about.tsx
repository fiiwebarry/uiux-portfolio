...
import Navbar from "../components/genericLayout/navbar";
...
const About = ({ onToggleSideBar, showSideBar }: NavbarProps) => {
  ...
  return (
    <>
      <Navbar onToggleSideBar={onToggleSideBar} showSideBar={showSideBar} />
      ...
      <section className=" md:mb-10 md:p-0 p-5">
        ...
        <div className="bg-[#121454] md:-mx-6  px-7 -mx-5 ">
          <div className=" max-w-7xl mx-auto grid md:py-20 py-10">
            ...
            <div className=" grid gap-9 text-[#D1D5DB] md:mb-16 md:text-2xl">
              ...
              <p>
                {" "}
                I design digital experiences that feel obvious (in the best
                way). Every screen has a reason. Every interaction has intent.
                If a user has to pause and think too hard, something went wrong
                and I take that personally. (Politely. Professionally.)
              </p>
        ...
        <div className=" md:max-w-7xl md:pt-20 md:p-0 p-5 mx-auto grid md:grid-cols-2 gap-2  py-10 md:py-20">
          <div className="md:sticky md:top-32 md:self-start md:h-fit">
            ...
            <p className="text-[#1F1F1F] font-bold md:text-3xl">
              Product Design
            </p>
          </div>
          <div className="md:border-l grid gap-5 text-[#1F2937] md:text-xl border-[#D1D5DB] md:pl-40 ">
            ...
            <p>
              Someone has an idea. A team has a goal. Users have needs they
              can’t quite articulate yet. That’s where I start. I step into the
              early, messy stage of product thinking when questions matter more
              than answers.
            </p>
            <p>
        ...
        <div className=" md:max-w-7xl md:pt-20 md:p-0 p-5 mx-auto grid gap-2 md:grid-cols-2 py-10 ">
          ...
          <div className="md:border-l grid gap-5 text-[#1F2937] md:text-xl border-[#D1D5DB] md:pl-40 ">
            ...
            <p>
              The outcome isn’t guesswork or vague recommendations. It’s a
              clear, actionable UX roadmap prioritized improvements that help
              teams make confident decisions, reduce friction, and move forward
              with intention.
            </p>
            <p>
              {" "}
        ...
        <div className=" md:max-w-7xl md:pt-20 md:p-0 p-5 mx-auto  gap-2 md:mb-20 grid md:grid-cols-2 py-10">
          ...
          <div className="md:border-l grid gap-5 text-[#1F2937] md:text-xl border-[#D1D5DB] md:pl-40">
            ...
            <p>
              ...
              solving new problems. That’s when design systems stop being “nice
              to have” and start becoming essential.
            </p>
            <p>
